...
class OrderData {
  ...
  OrderData({this.id, this.productId, this.amount, this.price, this.userId, this.driverId, this.address, this.lat, this.lang, this.status, this.type, this.rate, this.replay, this.createdAt, this.updatedAt, this.products, this.driver});
